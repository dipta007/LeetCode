<h2><a href="https://leetcode.com/problems/swap-nodes-in-pairs/?envType=company&envId=facebook&favoriteSlug=facebook-thirty-days&status=TO_DO">24. Swap Nodes in Pairs</a></h2><h3>Medium</h3><hr><p>Given a&nbsp;linked list, swap every two adjacent nodes and return its head. You must solve the problem without&nbsp;modifying the values in the list&#39;s nodes (i.e., only nodes themselves may be changed.)</p>
